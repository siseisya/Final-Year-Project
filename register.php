...
include('dbconnect.php');
    ...
    if (isset($_POST['register'])) {
        ...
        $sql = "INSERT INTO student (Fullname, TypeS, Faculty, Address, Phonenumber)
        VALUES ( fullname, types, faculty, address, semester, mobileno
        
        
        Fullname=:fullname, TypeS=:types, Faculty=:faculty, Address=:address, Semester=:semester,
