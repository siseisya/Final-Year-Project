...
?>
    ...
    <head>
        ...
        <!-- Title -->
        <title>Admin | Approved Bus Applications</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <div style="margin-left:20%">
            ...
            <div class="w3-container">
                ...
                <h3>Approved Bus Applications History</h3>
                ...
                <table id="approved">
                    ...
                    <tbody>
                        <?php
                        $status = 1;
                        $sql = "SELECT trybook.id as lid, student.Fullname, student.Matric, student.id, trybook.Programme, trybook.PostingDate, trybook.Status from trybook 
join student on trybook.empid=student.id where trybook.Status=:status order by lid desc";
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td><a href="editemployee.php?empid=<?php echo htmlentities($result->id); ?>" target="_blank"><?php echo htmlentities($result->Fullname); ?>(<?php echo htmlentities($result->Matric); ?>)</a></td>
